			...
			// Settings
				settings: {
					...
					// Desktop only
						...
						introDelay:			1,		// Delay (in ms) before showing the reel
						introSpeed:			1,		// Speed (in ms) at which to fade in reel
						...
						padding:			5,			// Padding (in px) between items (0 = no padding)
						paddingColor:		'#fff',		// Padding color
						resetScroll:		false,		// If true, reel scroll will reset on page refresh
						scrollFactor:		0.5,			// Scales the scroll delta (1 = normal, 2 = double, 0.5 = half, etc.)
						...
						thumbDelay:			1,		// Delay (in ms) before showing thumbnails
						thumbDelaySpread:	1,		// Spread (in ms) to randomly stagger thumbnails (0 = don't stagger)
						thumbSpeed:			1,		// Speed (in ms) at which to fade in thumbnails
