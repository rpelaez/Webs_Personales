...
$(function() { h5u_parallelism.init({
		...
		itemHeight: 230,
		padding: 6, /* change the padding for thickness of the white frames */
		introDelay:2000,
		
		/*popupOverlayOpacity:	0.95,    for changing the popped window overlap opacity*/
			...
			// Settings
				settings: {
					...
					// Desktop only
						...
						introDelay:			850,		// Delay (in ms) before showing the reel
